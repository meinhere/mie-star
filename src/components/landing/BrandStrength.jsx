            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-10">
                <div className="max-w-3xl mb-16">
                    ...
                    <p className="text-[#3D1F00]/60 mt-5 text-lg">
                        Brand yang tumbuh cepat, viral di Jakarta, dan didukung
                        komunitas loyal — dari pelanggan harian hingga celebrity
                        marketing.
                    </p>
                </div>
                ...
                <div className="mt-14 grid grid-cols-1 md:grid-cols-3 gap-6">
                    {[
                        {
                            title: "93% Rating Positif",
                            desc: "Konsisten unggul di 5 platform review & delivery.",
                        },
                        {
                            title: "Ekspansi Cepat",
                            desc: "10 stores dalam kurang dari 1 tahun operasional.",
                        },
                        {
                            title: "Viral di Jakarta",
                            desc: "10M+ celebrity marketing engagement per bulan.",
                        },
                    ].map((p, i) => (
                        <motion.div
                            key={p.title}
                        ...
                        >
                            <div className="font-display text-2xl text-[#3D1F00] mb-2">
                                {p.title}
                            </div>
                            <div className="text-sm text-[#3D1F00]/60">
                                {p.desc}
                            </div>
                        </motion.div>
                    ))}
